$(function () {
    ...
    $(".zz").fadeIn(1000,function () {
        $outbox.css({background:"url(./BackGround/1.jpg) no-repeat 0 0",
                ...
                switch (count){
                    ...
                    case 56:
                        $(".zz").stop(true,true).fadeIn(300,function () {
                            $outbox.css({background:"url(./BackGround/"+28+".png) no-repeat 0 0",
                                backgroundSize:"1200px 600px"});
                        }).fadeOut(500);
                    ...
                    case 87:
                        removeman("mryjsp");
                        $("#man").append("<img src='./Character/gcyjsp.gif' id='gcyjsp'>");
                        $("#gcyjsp").css({
                            left:980,
                            bottom:100,
                            height:200
...
function SetBackGround() {
    img++;
    $outbox.css({background:"url(./BackGround/"+img+".jpg) no-repeat 0 0",
        backgroundSize:"1200px 600px"});
}
function play(name) {
...
function manpos(info) {
    ...
    $("#man").append("<img src='./Character/"+info.id+".png' id="+info.id+">");
    $("#"+info.id).css({
        left:info.left,
        bottom:info.bottom,
        height:info.height,
